                        ...
                        <div class="card bg-warning invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <span class="text-white fs-18">Internships</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-success invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    ...
                                    <span class="text-white fs-18">Extra Curricular Activities</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-info invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">3</h2>
                                    <span class="text-white fs-18">Total Hackathons</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-secondary invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num">4</h2>
                                    <span class="text-white fs-18">Total Projects</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-xxl-5">
                        <div class="card">
                            <div class="card-header border-0 pb-0">
                                <div>
                                    <h4 class="card-title mb-2">Monthly Progress</h4>
                                    <span class="fs-12">Monthly Uploaded achievements</span>
                                </div>
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                                    <span>Projects</span>
                                    <span class="fs-18"><span class="text-black pe-2">3</span>/5</span>
                                </div>
                                <div class="progress default-progress mt-4">
                                    <div class="progress-bar bg-gradient-2 progress-animated" style="width: 70%; height:20px;" role="progressbar">
                                ...
                                <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                                    ...
                                    <span class="fs-18"><span class="text-black pe-2">1</span>/1</span>
                                </div>
                                <div class="progress default-progress mt-4">
                                    <div class="progress-bar bg-gradient-2 progress-animated" style="width: 70%; height:20px;" role="progressbar">
                                ...
                                <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                                    ...
                                    <span class="fs-18"><span class="text-black pe-2">2</span>/5</span>
                                </div>
                                <div class="progress default-progress mt-4">
                                    <div class="progress-bar bg-gradient-2 progress-animated" style="width: 70%; height:20px;" role="progressbar">
                        ...
                        <div class="card">
                            <div class="card-header d-flex flex-wrap border-0 pb-0">
                                <div class="me-auto mb-sm-0 mb-3">
                                    <h4 class="card-title mb-2">Student Overview</h4>
                                    <span class="fs-12">All progress bars of an year</span>
                                </div>
                            ...
                            <div class="card-body pb-2">
                                <div class="d-sm-flex d-block">
                                    ...
                                    <ul class="card-list d-flex mt-sm-0 mt-3">
                                        <li class="me-3"><span class="bg-success circle"></span>Hackathons</li>
                                        <li><span class="bg-danger circle"></span>Project</li>
                                    </ul>
                                </div>
